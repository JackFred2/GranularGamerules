...
public abstract class FoxEatBerriesGoalMixin {
    ...
    @Definition(id = "getServerLevel", method = "Lnet/minecraft/world/entity/animal/Fox$FoxEatBerriesGoal;getServerLevel(Lnet/minecraft/world/level/Level;)Lnet/minecraft/server/level/ServerLevel;")
    ...
    @Expression("getServerLevel(this.field_17975.level()).getGameRules().getBoolean(RULE_MOBGRIEFING)")
